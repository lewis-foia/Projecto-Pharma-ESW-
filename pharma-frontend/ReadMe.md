...
│ │ ├── Dashboard.tsx # Dashboard com gráfico de vendas
│ │ ├── Products.tsx # CRUD de medicamentos
│ │ ├── Sales.tsx # Histórico de vendas + registo rápido
│ │ └── Admin/
│ │ └── Users.tsx # Gestão de utilizadores (admin)
│ ├── services/
│ │ └── mockApi.ts # API mock com dados em memória
│ ├── types/
│ │ └── index.ts # Interfaces TypeScript (User, Product, Sale)
...
Todos os dados são mantidos em arrays em memória. Ao recarregar a página, as vendas e stocks voltam ao estado inicial. Ideal para desenvolvimento e demonstrações.